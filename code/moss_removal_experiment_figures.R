...
yTitle2 = 'Mean plant size (log mg)\n'
...
fig1 <- 
  ggplot(data = prop_success, aes( x = Position, 
                                   y = result, 
...
fig2 <- 
  ggplot(data = size, aes( x = Position, y = result, ymin = result - stand_err, 
                                         ymax = result + stand_err, group = Treatment, 
...
fig3 <- ggplot(data = infls, aes( x = Position, y = result, ymin = result - stand_err, 
                                ymax = result + stand_err, group = Treatment, 
                                color = Treatment, shape = Treatment)) + 
  geom_point(position = position_dodge(width = 0.2), size = 4) + 
  geom_line(stat = 'identity', position = position_dodge( width = 0.2)) + 
